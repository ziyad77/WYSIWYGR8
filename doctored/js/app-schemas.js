...
(function(){
    ...
    doctored.schema_family = { //a way of grouping multiple schemas into types (e.g. DocBook 4 and 5 are both "docbook")
        ...
        'EAST': {
            name: "EAST",
            new_document_xml: '<?xml version="1.0"?><EAST xmlns="http://www.w3.org/2001/XMLSchema"><head><title>Titre Page</title></head><body><p>Commencer votre présentation</p></body></html>'
        },
        'html': {
            name: "HTML",
